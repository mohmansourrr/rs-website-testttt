...
const en = {
  ...
  contact: {
    ...
    successText:
        'Your enquiry is ready with all your details filled in — press Send in WhatsApp and it reaches our sales team straight away.',
    successAgain: 'Send Another',
    disclaimer: 'Your enquiry goes straight to our sales team on WhatsApp. Treated in confidence.',
...
const ar: Translation = {
  ...
  contact: {
    ...
    successText:
        'طلبك جاهز وبه كل بياناتك — اضغط إرسال في واتساب ليصل إلى فريق المبيعات مباشرة.',
    successAgain: 'إرسال رسالة أخرى',
    disclaimer: 'يصل طلبك مباشرة إلى فريق المبيعات على واتساب، ويُعامل بسرية تامة.',
