...
const ar: Translation = {
  ...
  products: {
    ...
    range: [
      {
        name: 'ألواح ولفائف الستانلس ستيل',
      ...
      {
        name: 'مواسير وأنابيب الستانلس ستيل',
      ...
      {
        name: 'قضبان وزوايا الستانلس ستيل',
  ...
  contact: {
    ...
    productOptions: [
      ...
      'قضبان وزوايا الستانلس ستيل',
      'الستانلس ديكور والألوان',
